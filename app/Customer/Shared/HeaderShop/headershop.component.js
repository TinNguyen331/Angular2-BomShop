...
var HeaderShopComponent = (function () {
    function HeaderShopComponent(el) {
        this.el = el;
    }
    HeaderShopComponent.prototype.ngAfterViewInit = function () {
    ...
    HeaderShopComponent.prototype.ngOnInit = function () { };
    HeaderShopComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
            selector: 'customer-headershop',
            templateUrl: 'headershop.component.html'
        }), 
        __metadata('design:paramtypes', [core_1.ElementRef])
    ], HeaderShopComponent);
    return HeaderShopComponent;
}());
exports.HeaderShopComponent = HeaderShopComponent;
//# sourceMappingURL=headershop.component.js.map